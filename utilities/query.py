...
def create_query(user_query, click_prior_query, filters, sort="_score", sortDir="desc", size=10, source=None, name_search_field="name"):
    query_obj = {
        'size': size,
        "sort": [
            {sort: {"order": sortDir}}
                        ...
                        "should": [  #
                            ...
                            },
                            {
                                "multi_match": {
                                    ...
                                    "fields": [f"{name_search_field}^10", "name.hyphens^10", "shortDescription^5",
